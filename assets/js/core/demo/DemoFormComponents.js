(function (namespace, $) {
	...
	p._initSelect2 = function () {
		...
		var $select = $(".select2-list").select2({
			allowClear: true,
			language: "es"
		});
	...
	p._initDatePicker = function () {
		...
		$('#demo-date').datepicker({autoclose: true, todayHighlight: true, format: "yyyy/mm/dd", language: "es"});
		$('#demo-date-month').datepicker({autoclose: true, todayHighlight: true, minViewMode: 1, format: "yyyy/mm/dd", language: "es"});
		$('#demo-date-format').datepicker({autoclose: true, todayHighlight: true, format: "yyyy/mm/dd",  language: "es"});
		$('#demo-date-range').datepicker({todayHighlight: true, format: "yyyy/mm/dd", language: "es"});
		$('#demo-date-inline').datepicker({todayHighlight: true, format: "yyyy/mm/dd", language: "es"});

		$('#demo-date-val').datepicker({autoclose: true, todayHighlight: true, format: "yyyy/mm/dd", language: "es", minDate: 0 });
	};
