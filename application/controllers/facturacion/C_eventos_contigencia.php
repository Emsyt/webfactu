...
class C_eventos_contigencia extends CI_Controller {
   ...
   function eventos_fuera_de_linea(){
        ...
        $cufdEvento = $this->eventos->get_cufd_evento($idcufd);
        $cufdEvento = $cufdEvento[0]->cod_cufd;
        //$cufdActivo = $this->eventos->get_cufd($facturacion[0]->cod_punto_venta,'ACTIVO');
        ...
        echo $this->eventos->eventos($SolicitudEvento,$facturacion[0]->cod_token);
    ...
    function listar_eventos(){
        ...
        $resp = $this->eventos->get_lst_eventos($id_cufd);
        echo json_encode($resp);
    }
    ...
    function listar_cufd(){

        $fecha_inicial = $this->input->post('fecha_inicial');
        $fecha_fin = $this->input->post('fecha_fin');

        $data = $this->eventos->listar_cufd($fecha_inicial,$fecha_fin);
