...
class M_configuracion extends CI_Model {
  ...
  public function M_credenciales_facturacion($codPuntoVenta) {
    $query = $this->db->query("SELECT * FROM fn_credenciales_facturacion($codPuntoVenta);");
    return $query->result();
  }
  ...
  public function M_datos_iniciales_cuis(){
